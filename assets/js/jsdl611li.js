...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(j).1q(6(){g(1v.3a.2l==="2m.2n"){6 1b(1X,1f,y=2o){g(1X==\'L\'){7 Q=\'2p\';7 H=\'<i 8="1W-1 1V q-2k-1T"></i>\'}z{7 Q=\'K\';7 H=\'<i 8="1W-1 1V q-2C-1T"></i>\'}7 I=1d 1U().2v();g(2w $(".d-D").v()==="2x"){$("1e").16(\'<9 8="d-D 1R-5 1R-2z-0 2B-2u d-2q p-3 2A-0 2y-0"></9>\');$(".d-D").16(`<9 2e="W"E-2d="2c"V-U="${I}"4-Y-y="${y}"E-25="13"8="d 2a 2b"><9 8="d-29 24-${Q}"><S 8="26-2j m-0 27-14">${H}2fôG báo</S> <r 4-Y-2h="d" E-2i="1L" 8="P-1t 1p-1n"><i 8="q q-1x 1B-1D"></i></r></9><9 8="d-1e"><r>${1f}</r></9></9></9>`);7 T=1F(()=>{1G(T);$(`[V-U="${I}"]`).1i()},y)}z{$(".d-D").16(`<9 2e="W"E-2d="2c"V-U="${I}"4-Y-y="${y}"E-25="13"8="d 2a 2b"><9 8="d-29 24-${Q}"><S 8="26-2j m-0 27-14">${H}2fôG báo</S> <r 4-Y-2h="d" E-2i="1L" 8="P-1t 1p-1n"><i 8="q q-1x 1B-1D"></i></r></9><9 8="d-1e"><r>${1f}</r></9></9></9>`);7 T=1F(()=>{1G(T);$(`[V-U="${I}"]`).1i();g($(".d-D").v()==\'\'){$(".d-D").1i()}},y)}}6 12(2,u,f){$.O({f:\'/22/\'+2,s:\'1N\',K:6(4){$(\'#1O\').v(4);j.u=u;2t.2s({2:2},u,f);$(\'10.1C-11\').1m(\'B\');$(\'a[4-2="\'+2+\'"]\').2r(\'10.1C-11\').17(\'B\');$(\'a.1A-1z\').1m(\'1J-1w-1u-B\');$(\'a.1A-1z[4-2="\'+2+\'"]\').17(\'1J-1w-1u-B\');$(\'10.1o-11\').1m(\'B\');$(\'a[4-2="\'+2+\'"]\').2E(\'10.1o-11\').17(\'B\')},L:6(){W(\'23ôG 1Qể tải 1S.\')}})}$(j).15(\'1E\',\'a[4-2]\',6(e){e.1P();7 2=$(1k).4(\'2\');7 u=$(1k).P();7 f=2===\'1h\'?\'/\':\'/\'+2;12(2,u,f)});$(1v).15(\'3B\',6(e){7 w=e.3z.w;g(w){12(w.2,w.2.3x(0).3w()+w.2.3u(1),\'/\'+w.2)}z{12(\'1h\',\'3j 3eủ\',\'/\')}});6 3d(){j.1l("1H").1E()}6 3r(){7 1I=j.1l("1H");7 N=1I.N;7 M=j.1l("3C");M.3f="";3g(7 i=0;i<N.1y;i++){7 R=N[i];7 1c=1d 3h();1c.3i=(6(R){3l 6(e){7 Z=j.3m("3n");Z.2D="3o-3p";Z.3c=e.3q.1g;M.3s(Z)}})(R);1c.3t(R)}g(N.1y>0){M.1s.1r="3v"}z{M.1s.1r="3y"}}$(j).1q(6(){$(j).15("1a","2g[1a-O=3A]",6(e){e.1P();k C=1k;k f=$(C).J("3k");k s=$(C).J("s");k 3b="2U/2g-4";k A=$(C).J("A");k F=1d 39(C);k h=$(C).2G("h[1M=1a]");g(h.J("28")){2H.2I({u:"Xác 2Jận!",P:h.J("28"),H:"2K",2L:13,2M:"#2N",2O:"#2P",2Q:"ĐồG Ý",2R:"2Sát",}).2F((1g)=>{g(1g.2T){19(f,s,A,F,h)}})}z{19(f,s,A,F,h)}})});6 1j(2){2+=(2.2V("?")?"&":"?")+"2W="+1U.2X();$.O({f:\'/22/\'+2,s:\'1N\',K:6(4){$(\'#1O\').v(4)},L:6(){W(\'23ôG 1Qể tải 1S.\')}})}6 19(f,s,A,F,h){k 20=h.v().2Y();k 1K={1M:s,f,4:F,2Z:"30",31:18,32:18,33:6(){h.1Y("1Z",13).v(\'<i 8="34 q-35 q-36"></i> Đ37 xử lý...\')},38:6(){h.1Y("1Z",18).v(20)},K:6(4){g(4.L){1b(\'L\',4.21)}z{1b(\'K\',4.21);g(!4.A){1j(\'1h\')}z{1j(4.A)}}}};$.O(1K)}}});',62,225,'||page||data||function|var|class|div||||toast||url|if|button||document|let||||||fa|span|method||title|html|state||delay|else|href|active|_this|container|aria|formData|ng|icon|date|attr|success|error|imagePreviewsContainer|files|ajax|text|statuss|file|h5|load|id|toasts|alert||bs|imagePreview|li|item|changePage|true||on|append|addClass|false|submitForm|submit|noti|reader|new|body|message|result|home|remove|reload|this|getElementById|removeClass|pointer|profile|cursor|ready|display|style|white|exact|window|link|times|length|route|admin|fw|nav|normal|click|setInterval|clearInterval|fileInput|input|nuxt|setting|Close|type|GET|content|preventDefault|th|mt|trang|circle|Date|fal|pe|status|prop|disabled|textButton|msg|get|Kh|bg|atomic|me|fs|order|header|fade|show|assertive|live|role|Th|form|dismiss|label|auto|exclamation|hostname|tricker|vn|5000|danger|center|parent|pushState|history|fixed|getTime|typeof|undefined|end|sm|top|position|check|className|closest|then|find|Swal|fire|Nh|warning|showCancelButton|confirmButtonColor|3085d6|cancelButtonColor|d33|confirmButtonText|cancelButtonText|Tho|isConfirmed|multipart|includes|cache|now|trim|dataType|json|processData|contentType|beforeSend|fas|spinner|spin|ang|complete|FormData|location|enctype|src|chooseFile|ch|innerHTML|for|FileReader|onload|Trang|action|return|createElement|img|image|preview|target|showSelectedFiles|appendChild|readAsDataURL|slice|block|toUpperCase|charAt|none|originalEvent|duogxaolin|popstate|imagePreviews'.split('|'),0,{}))
