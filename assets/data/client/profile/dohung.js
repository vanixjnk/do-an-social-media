...
const profile = {
    ...
    cover: "/assets/img/cover/dohungbg.jpg",
    study: "Freshman at HCMUE",
    location: "Live at Binh Phuoc",
    status: "Single",
    followers: "20478",
};

const posts = [{
        time: "November 3 at 2:00 AM",
        content:"Trẻ con sa mạc truyền tai nhau bài đồng dao Xương rồng đơm lá đơm hoa Nước đong đầy trên cao nguyên đá Là ngày Hoàng đế trở về nhà T1 VÔ ĐỊCHHHHHHHH",
        image:"/assets/img/posts/dohung.jpg",
    },
